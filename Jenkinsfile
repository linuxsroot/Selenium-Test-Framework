pipeline {
	...
	stages {
		...
		stage('Checkout') {
			steps {
				git branch: 'main', url: 'https://github.com/linuxsroot/Selenium-Test-Framework.git'
			}
		}
	...
	post {
		...
		success {
			emailext (
                ...
                <p><b>Extent Report:</b>
                   <a href="http://localhost:8080/job/${env.JOB_NAME}/HTML_20Extent_20Report/">Click here</a>
                </p>
                <p>Best regards,</p>
